...
CONTENT_TYPES = {
    ...
    for policy in (
        ...
        _policy("crypto_market", "仮想通貨価格急変", "market_service_screenshot", "auto", False, 95),
        _policy("trending_token", "話題トークン価格", "market_service_screenshot", "hybrid", False, 88),
        _policy("us_stock", "米国株価格急変", "market_service_screenshot", "hybrid", False, 88),
        _policy("jp_stock", "日本株価格急変", "market_service_screenshot", "hybrid", False, 88),
        ...
        _policy("historical_milestone", "史上最高・歴史的水準", "market_service_screenshot", "hybrid", False, 76),
        _policy("cross_asset", "複数資産の比較・乖離", "market_service_screenshot", "hybrid", False, 76),
