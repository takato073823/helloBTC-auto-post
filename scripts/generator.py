...
<div class="swell-block-step__item"><div class="swell-block-step__number u-bg-main"><span class="__label">STEP</span><span class="__num">1</span></div><div class="swell-block-step__title">ステップタイトル（動詞で）</div><div class="swell-block-step__body"><!-- wp:paragraph --><p>具体的な手順の説明。所要時間や注意点も添える。</p><!-- /wp:paragraph --></div></div>
<!-- /wp:loos/step-item -->
<!-- wp:loos/step-item {{"stepLabel":"STEP"}} -->
<div class="swell-block-step__item"><div class="swell-block-step__number u-bg-main"><span class="__label">STEP</span><span class="__num">2</span></div><div class="swell-block-step__title">ステップ2タイトル</div><div class="swell-block-step__body"><!-- wp:paragraph --><p>説明テキスト</p><!-- /wp:paragraph --></div></div>
<!-- /wp:loos/step-item -->
</div>
<!-- /wp:loos/step -->
...
<div class="swell-block-step" data-num-style="circle">
<!-- wp:loos/step-item {"stepLabel":"STEP"} -->
<div class="swell-block-step__item"><div class="swell-block-step__number u-bg-main"><span class="__label">STEP</span><span class="__num">1</span></div><div class="swell-block-step__title">ステップタイトル（動詞形）</div><div class="swell-block-step__body"><!-- wp:paragraph --><p>具体的な手順。注意点も含める。</p><!-- /wp:paragraph --></div></div>
<!-- /wp:loos/step-item -->
<!-- wp:loos/step-item {"stepLabel":"STEP"} -->
<div class="swell-block-step__item"><div class="swell-block-step__number u-bg-main"><span class="__label">STEP</span><span class="__num">2</span></div><div class="swell-block-step__title">ステップ2</div><div class="swell-block-step__body"><!-- wp:paragraph --><p>説明テキスト</p><!-- /wp:paragraph --></div></div>
<!-- /wp:loos/step-item -->
</div>
<!-- /wp:loos/step -->
